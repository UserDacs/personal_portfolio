...
return new class extends Migration
{
    ...
    {
        DB::unprepared("
            CREATE PROCEDURE FUNCTION_SUBJECT_EMAIL(IN subjectFilter TEXT, IN recipientEmailFilter VARCHAR(255))
            BEGIN
                SELECT
                    s.id AS sender_id,
                ...
                WHERE s.`subject` = subjectFilter AND s.recipient_email = recipientEmailFilter
    ...
    {
        DB::unprepared("DROP PROCEDURE IF EXISTS FUNCTION_SUBJECT_EMAIL");
    }
};
